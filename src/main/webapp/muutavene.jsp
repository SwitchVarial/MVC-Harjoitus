...
$(document).ready(function(){
	...
	$.ajax({url:"veneet/haevene/"+tunnus, type:"GET", dataType:"json", success:function(result){	
...
function paivitaTiedot(){	
	...
	$.ajax({url:"veneet", data:formJsonStr, type:"PUT", dataType:"json", success:function(result) {    
		if(result.response==0){
	    	alert("Veneen tietojen päivittäminen epäonnistui.");
      }else if(result.response==1){
    	alert("Veneen tietojen päivittäminen onnistui.");
	  }
  }});	
}
</script>
